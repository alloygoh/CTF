...
poracle = Poracle.new(BLOCKSIZE, verbose = true) do |data|
  shell_st = "echo 5468697320697320616e204956343536" + data.unpack("H*").pop + " | nc 2018shell1.picoctf.com 27533"
...
data = '{"username": "admin", "expires": "2020-01-07", "is_admin": "true"}'
...
data = result  # = "7bb373a480bd0bb262d6d79fadf25696aaa48ed64111a6aabf4dbbbed68f5da041414141414141414141414141414141" # 'c196ffe46b23d4
